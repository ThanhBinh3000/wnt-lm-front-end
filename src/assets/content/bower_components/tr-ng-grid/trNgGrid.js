...
(function (TrNgGrid) {
    ...
    TrNgGrid.defaultColumnOptionsTemplate = {
        ...
        enableSorting: null,
        displayTotalItemsCount: false,
        enableClientSortingMode: false,
        isInServerSideMode: false
};
    ...
    var GridController = (function () {
        ...
        GridController.prototype.setupGrid = function (gridScope, gridOptions, isInServerSideMode) {
            ...
            this.gridOptions.isInServerSideMode = isInServerSideMode;
            ...
            if (gridOptions.displayTotalItemsCount === undefined) {
                gridOptions.displayTotalItemsCount = true;
            }
            if (gridOptions.enableClientSortingMode === undefined) {
                gridOptions.enableClientSortingMode = true;
            }
        ...
        GridController.prototype.setupServerSideModeTriggers = function (gridScope) {
            ...
            if (this.isInServerSideMode) {
                ...
                this.scheduleServerSideModeDataRetrieval = function (callDirectRetrieveData) {
                    if (callDirectRetrieveData == true) {
                ...
                this.speedUpServerSideModeDataRetrieval = function ($event, cancelServerRequest) {
                    if (cancelServerRequest == true) {
                ...
                var initCycle = true;
                var watchCollections = "[" + "gridOptions.filterBy, " + "gridOptions.filterByFields, " + "gridOptions.pageItems ";
                if (!_this.gridOptions.enableClientSortingMode) {
                    watchCollections += (", gridOptions.orderBy, " + "gridOptions.orderByReverse ");
                }
                watchCollections += "]";
                gridScope.$watchCollection(watchCollections, function (newValues, oldValues) {
                    if (initCycle) {
                        initCycle = false;
                    }
                    else {
                        ...
                        var callDirectGettingData = false;
                        if (_this.gridOptions.enableClientSortingMode == true) {
                            callDirectGettingData = true;
                        }
                        _this.scheduleServerSideModeDataRetrieval(callDirectGettingData);
        ...
        GridController.prototype.toggleSorting = function (propertyName, scope) {
            ...
            if (this.isInServerSideMode == true
                && this.gridOptions.enableClientSortingMode == true) {
                var gridScope = scope.$parent.$parent;
                this.computeFilteredItemsInClientMode(gridScope);
                this.speedUpServerSideModeDataRetrieval(null, true);
            }
            else
            {
                this.speedUpServerSideModeDataRetrieval();
        ...
        GridController.prototype.computeFilteredItemsInServerMode = function (scope) {
            try {
        ...
        GridController.prototype.computeFilteredItemsInClientMode = function (scope) {
            try {
                // apply filters first
        ...
        GridController.prototype.computeFilteredItems = function (scope) {
            if (this.isInServerSideMode) {
                ...
                this.computeFilteredItemsInServerMode(scope);
            }
            else {
                // apply filters first
                this.computeFilteredItemsInClientMode(scope);
            }           
        };
    ...
    angular.module("trNgGrid", []).directive(tableDirective, [
        function () {
            return {
                ...
                scope: {
                    ...
                    onDataRequiredDelay: '=?',
                    fields: '=?',
                    displayTotalItemsCount: '=?',
                    enableClientSortingMode: '=?',
                },
                ...
                compile: function (templateElement, tAttrs) {
                    ...
                    return {
                        ...
                        post: function (isolatedScope, instanceElement, tAttrs, controller, transcludeFn) {
                            ...
                            gridScope.isInServerSideMode = !!tAttrs.onDataRequired;
                    ...
                    return {
                        ...
                        pre: function (scope, instanceElement, tAttrs, controller, $transclude) {
                            ...
                            scope.toggleSorting = function (propertyName) {
                                controller.toggleSorting(propertyName, scope);
                            };
        ...
        function () {
            var setupScope = function (scope, controller) {
                ...
                scope.displayTotalItemsCount = (typeof (scope.gridOptions.displayTotalItemsCount) != "undefined" && scope.gridOptions.displayTotalItemsCount != null) ? scope.gridOptions.displayTotalItemsCount:true;
        ...
        return function (input, gridOptions) {
            if (gridOptions.isInServerSideMode == true && gridOptions.enableClientSortingMode == true ) {
                return input;
            }
